...
function buscarUsuario() {
  ...
  function cargarUsuarios() {
    ...
    xhttp.open("GET", "obtener_admin.php", true); // Reemplaza "obtener_usuarios.php" con la URL de tu script PHP para obtener usuarios
    xhttp.send();
  }
  ...
  function editarUsuario(id) {
    ...
    window.location.href = "editar_admin.php?id=" + id;
  }
  ...
  function eliminarUsuario(id) {
    ...
    xhttp.open("POST", "eliminar_admin.php", true); // Reemplaza "eliminar_usuario.php" con la URL de tu script PHP para eliminar usuarios
