                            ...
                            <div class="card shadow mb-4">
                                ...
                                <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Ingresa el nombre..." class="form-control" id="nombre" name="nombre" pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s]+" title="Solo letras y espacios permitidos" required oninput="this.value = this.value.replace(/[^A-Za-zñÑáéíóúÁÉÍÓÚ\s]/g, ''); this.value = this.value.toUpperCase();">
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" placeholder="Ingresa el correo..."  class="form-control" id="correo" name="correo" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="password" placeholder="Ingresa la contraseña para el usuario..." class="form-control" id="contrasena" name="contrasena" required>
