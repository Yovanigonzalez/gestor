                            ...
                            if (isset($_GET['expediente']) && isset($_GET['servicio']) && isset($_GET['nombre_cliente']) && isset($_GET['ap_paterno']) && isset($_GET['ap_materno']) && isset($_GET['razon']) && isset($_GET['id_nombre_seleccionado'])) {
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "</div>";
                                        echo "<div class='form-group'>";
                                        echo "<label for='enfermedades'>ENFEREMEDADES CRONICAS:</label>";
                                        ...
                                        echo "</div>";
                                        echo "<div class='form-group'>";
                                        echo "<label for='antecedentes'>ANTECEDENTES FAMILIARES::</label>";
                                        ...
                                        echo "<input type='text' class='form-control' id='resultados' name='resultados' oninput=\"this.value = this.value.toUpperCase()\">";
                                        echo "</div>";
